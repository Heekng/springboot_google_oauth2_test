package com.heekng.springboot_oauth_test.config.auth;

import com.heekng.springboot_oauth_test.entity.Role;
import com.heekng.springboot_oauth_test.service.CustomOAuth2UserService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .headers().frameOptions().disable() //h2-console 화면ㅅ ㅏ용
                .and()
